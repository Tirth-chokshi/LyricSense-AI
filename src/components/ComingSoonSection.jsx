...
const ComingSoonFeature = ({ title, description }) => (
  <li className="flex items-center space-x-3 p-3 bg-secondary rounded-md shadow-sm transition-all hover:shadow-md">
...
export const ComingSoonSection = () => {
  ...
  return (
    <section className="bg-card rounded-lg shadow-lg p-8 transition-all hover:shadow-xl">
      <h2 className="text-3xl font-bold mb-6 text-card-foreground">Features in the Pipeline...</h2>
      {/* <div className="mb-6">
        <Input
          type="text"
